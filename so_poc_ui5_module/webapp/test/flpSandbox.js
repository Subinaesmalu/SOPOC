		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sopocappnssopocui5module-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sopocappnssopocui5module-display": {
								"semanticObject": "sopocappnssopocui5module",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sopocappns.sopocui5module",
									"url": sap.ui.require.toUrl("sopocappns/sopocui5module")
								}
							}
						}
					}
